    ...
    ISimpleGaugeVoterStorageEventsErrors
{
    ...
    GaugeDistributorVoterSetup voterSetup;
    ...
    function _setupVoterContracts() public {
        ...
        voterBase = address(new GaugeDistributorVoter());

        // deploy setup
        voterSetup = new GaugeDistributorVoterSetup(
            voterBase,
        ...
        // fetch the contracts
        voter = GaugeDistributorVoter(pluginAddress);
