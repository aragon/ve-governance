...
import {GaugeDistributorVoter} from "@voting/GaugeDistributorVoter.sol";
...
contract GaugeDistributorVoterSetup is PluginSetup {
    ...
    function prepareInstallation(
        ...
        GaugeDistributorVoter voter = GaugeDistributorVoter(
            voterBase.deployUUPSProxy(
                abi.encodeCall(
                    GaugeDistributorVoter.initialize,
