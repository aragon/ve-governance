...
deploy-1-4-citrea-test :; forge script script/deploy/DeployGauges_v1_4_0_xCTR.s.sol:DeployGaugesV1_4_0_xCTR \
	--rpc-url $(RPC_URL) \
	--private-key $(DEPLOYMENT_PRIVATE_KEY) \
	--broadcast \
	--slow \
	...
	-vvv 2>&1 | tee script/deploy/citrea-test-deployment-output.log
